...
import helpimage from '../../assets/images/hero2.png'
    ...
    <div>
      <section class="bg-white dark:bg-transparent">
        <div class="container px-6 py-10 mx-auto">
          <h1 class="text-2xl text-center font-bold text-gray-800 capitalize lg:text-3xl dark:text-gray-900">
            How can
            <br /> we Help you?
          </h1>
          <p className="text-center lg:mx-20">
          ...
          <div class="mt-8 xl:mt-12 lg:flex lg:items-center">
            <div class="grid w-full grid-cols-1 gap-8 lg:w-1/2 xl:gap-16 md:grid-cols-2">
              <div class="space-y-3">
                <span class="inline-block p-3 text-blue-500 bg-blue-100 rounded-xl dark:text-gray-900 dark:bg-blue-500">
                  <svg
                ...
                <h1 class="text-xl font-semibold text-gray-700 capitalize dark:text-gray-900">
                  Heart surgery
                </h1>
              ...
              <div class="space-y-3">
                ...
                <p class="text-gray-500 dark:text-gray-900">
                  ...
                  benefits. Quickly disseminate superior deliverable
                  applications.
                </p>
              </div>
