...
//   }, [])
  ...
  return (
    <div className='grid lg:grid-cols-2 grid-cols-1'>
      <div
        className='flex flex-col m-3 max-w-lg p-6 space-y-6 overflow-hidden rounded-lg shadow-md dark:bg-gray-900 dark:text-gray-100'
        bis_skin_checked='1'
      >
        <div className='flex space-x-4' bis_skin_checked='1'>
          ...
          <div className='flex flex-col space-y-1' bis_skin_checked='1'>
            ...
            <span className='text-xs dark:text-gray-400'>Rating:{rating}</span>
          </div>
        </div>
        ...
        <div className='flex flex-wrap justify-between' bis_skin_checked='1'>
          ...
          <div
            className='flex space-x-2 text-sm dark:text-gray-400'
            bis_skin_checked='1'
          >
