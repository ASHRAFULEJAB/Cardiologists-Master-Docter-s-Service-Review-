      ...
      <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
        <div className="grid row-gap-10 mb-8 lg:grid-cols-6">
          <div className="grid grid-cols-2 gap-5 row-gap-8 lg:col-span-4 md:grid-cols-4">
            ...
            <div>
              <p className="font-medium tracking-wide text-gray-300">News</p>
              <ul className="mt-2 space-y-2">
                <li>
                  <Link
                    to="/"
            ...
            <div>
              <p className="font-medium tracking-wide text-gray-300">Shop</p>
              <ul className="mt-2 space-y-2">
                <li>
                  <Link
                    to="/"
            ...
            <form className="flex flex-col mt-4 md:flex-row">
              <input
                ...
                className="flex-grow w-full h-12 px-4 mb-3 transition duration-200 bg-white border
                 border-gray-300 rounded shadow-sm appearance-none md:mr-2 md:mb-0
                  focus:border-purple-400 focus:outline-none focus:shadow-outline"
              />
              <button
                type="submit"
        ...
        <div className="flex flex-col justify-between pt-5 pb-10 border-t border-gray-800 sm:flex-row">
          <p className="text-sm text-gray-500">
            © Copyright 2023-24 Cardiologists. All rights reserved.
          </p>
